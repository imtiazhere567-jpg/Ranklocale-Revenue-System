    ...
    try:
        ...
        for row in clients:
            pg_cursor.execute(
                ...
                (row['id'], row['name'], row['email'], row['phone'], row['company'], row['status'], row['notes'], row['created_at'], row['updated_at'])
            )
        ...
        for row in contracts:
            ...
            """, (
                row['id'], row['contract_name'], row['date'], row['deadline'], row['workspace'], row['approved_date'], row['delay_reason'],
                row['client_id'], row['bdo_id'], row['platform_id'], row['platform_profile_id'], row['payment_channel_id'],
                row['client_type_id'], row['budget'], row['estimated_revenue'], row['payment_structure'], row['status'],
        ...
        for row in payments:
            pg_cursor.execute(
                ...
                (row['id'], row['contract_id'], row['amount'], row['payment_date'], row['payment_channel_id'], row['notes'], row['created_at'])
            )
        ...
        for row in milestones:
            pg_cursor.execute(
                ...
                (row['id'], row['contract_id'], row['description'], row['amount'], row['due_date'], row['status'], row['notes'], row['created_at'], row['updated_at'])
            )
